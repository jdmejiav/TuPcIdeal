                ...
                <div role="group" aria-labelledby="checkbox-group" className="preguntas_bas">
                  ...
                  <div className="conta5">
                      <div className="preguntaa5">
                          ...
                          <div className="icon info-presupuesto" style = {{top:"25px", left:"0px"}}>
                            <div className= "texto-info-presupuesto">
                              <p>La memoria RAM es la que permite abrir múltiples programas al mismo tiempo o abrir programas muy pesador</p>
                            </div>
                            <span><i class="far fa-question-circle"></i></span>
                  ...
                  <div className="conta6">
                    <div className="preguntaa6">
                      ...
                      <div className="icon info-presupuesto" style = {{top:"25px", left:"0px"}}>
                        <div className= "texto-info-presupuesto">
                          <p>Los discos de estado sólido sirven para que el sistema operativo encienda más rápido y abra más rápido los programas, son más caros que los mecánicos</p>
                        </div>
                        <span><i class="far fa-question-circle"></i></span>
                     </div>
                        </div>
